  ...
  const sections = [
    {
      ...
      desc: "Most students spend years learning theory but never touch real chip design workflows. Skills like verification, design flow understanding and clean code writing practices are rarely taught with industry depth.",
